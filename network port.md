...
1. Most common ports interviewers expect you to instantly recall (100% frequency): 22 (SSH), 80 (HTTP), 443 (HTTPS), 3306 (MySQL), 5432 (Postgres), 3389 (RDP), 6443 (Kubernetes API).

2. AWS-specific must-know for Security Groups / VPC:

22 (SSH) – Linux EC2 access

3389 (RDP) – Windows EC2

80 / 443 – Web access (public ELB/ALB)

2049 – EFS mounts

5432 / 3306 – RDS connections

6443 / 2379 / 10250 – Kubernetes nodes

9090 / 5601 / 3000 / 8080 – Internal dashboards
